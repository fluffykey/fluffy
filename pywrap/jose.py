...
def sign(claims, jwk, add_header=None, alg='HS256'):
    ...
    :param jwk: A `dict` representing the JWK to be used for signing of the
                :class:`~jose.JWS`. This parameter is algorithm-specific.  :parameter add_header: Additional items to be added to the header.  Additional headers *will* be authenticated.
